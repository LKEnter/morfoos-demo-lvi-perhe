...
const REVIEWS = [
  {
    quote:
      "VC-istuimen ja käsisuihkun vaihto sujui mutkattomasti mukavan asentajan voimin. Kiitos!",
    name: "Maria Salo",
    meta: "5 arvostelua",
    time: "10 kuukautta sitten",
  },
  {
    quote:
      "Asiantunteva palvelu. Saman katon alta saa sekä LVI-osia että asennustyötä. Liikkeestä saa myös hyvät ohjeet DIY-henkilöille eli tein itse ja säästän. Perustavarat löytyy suoraan hyllystä eli suosittelen tätä paikkaa, jos osia ei löydy muualta.",
    name: "Matti Virtanen",
    meta: "4 arvostelua",
    time: "3 vuotta sitten",
  },
  {
    quote:
      "Niin se on, että tämäkin yrittäjä venyy työpäivästään, että saa asiakkaan hoidettua ennen viikonloppua! Kiitos!",
    name: "Helena Korhonen",
    meta: "Local Guide · 78 arvostelua",
    time: "3 vuotta sitten",
  },
  {
    quote: "Asiantuntevaa ja nopeaa palvelua!! Kiitos hyvästä palvelusta Perheputki Etelä!!",
    name: "Janne L.",
    meta: "Local Guide · 17 arvostelua",
    time: "5 vuotta sitten",
  },
  {
    quote: "Hyvä palvelu ja tarvikkeet löytyy.",
    name: "Heikki Nieminen",
    meta: "Local Guide · 45 arvostelua",
    time: "5 vuotta sitten",
  },
  {
    quote: "Kiitos, asia hoitui ennätysajassa.",
    name: "Sanna Mäkinen",
    meta: "4 arvostelua",
      ...
      <div className="mx-auto max-w-[1200px] px-5 md:px-8">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-xl text-base leading-relaxed text-[var(--color-ink-muted)] md:text-lg">
              Suurin osa uusista asiakkaistamme tulee suositusten kautta — se kertoo enemmän kuin
              mikään mainoslause.
            </p>
          </div>
          <div className="flex items-center gap-3 rounded-2xl border border-[var(--color-border)] bg-white px-5 py-3.5">
            <GoogleMark />
            <div className="text-[14px] leading-tight">
              <div className="flex items-center gap-1.5 font-heading font-bold text-[var(--color-ink)]">
                4.8
                <Stars />
              </div>
              <p className="text-[var(--color-ink-muted)]">Esimerkkiarvosteluja</p>
            </div>
          </div>
        </div>
